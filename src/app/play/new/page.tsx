  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-outback-50 to-outback-100 px-6 py-16">
      <div className="mx-auto max-w-md">
        <h1 className="font-display text-3xl font-bold text-outback-900">Play vs Computer</h1>
        <p className="mt-2 text-outback-600">Enter your name and start a solo game against the AI.</p>
