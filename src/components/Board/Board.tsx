...
export default function Board({ gameState, width = 700, height = 700 }: BoardProps) {
  ...
  useEffect(() => {
    ...
    const trackPoints = getTrackPositions(centerX, centerY, trackRadius, trackSpaces.length);
  ...
  return (
    <div ref={containerRef} className="flex w-full justify-center overflow-auto">
      <canvas
        ref={canvasRef}
